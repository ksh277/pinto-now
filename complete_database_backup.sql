-- COMPLETE DATABASE BACKUP - PINTO 프로젝트
-- 생성일: 2025-09-06
-- 이 파일은 전체 데이터베이스 구조와 데이터를 포함합니다.
...
CREATE TABLE `product_stats` (
  ...
  CONSTRAINT `product_stats_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product_clicks` (
  ...
  CONSTRAINT `product_clicks_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `weekly_rankings` (
  ...
  CONSTRAINT `weekly_rankings_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product_shelf_banner_products` (
  ...
  KEY `product_id` (`product_id`),
  CONSTRAINT `product_shelf_banner_products_ibfk_1` FOREIGN KEY (`banner_id`) REFERENCES `product_shelf_banners` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_shelf_banner_products_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `inquiries` (
  ...
  CONSTRAINT `inquiries_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE SET NULL,
  CONSTRAINT `inquiries_ibfk_3` FOREIGN KEY (`answered_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Design` (
  ...
  PRIMARY KEY (`id`),
  KEY `created_by` (`created_by`),
  CONSTRAINT `Design_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- 완료 메시지
SELECT 'Complete database backup restoration completed successfully!' as result,
