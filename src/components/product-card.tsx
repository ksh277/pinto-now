...
export function ProductCard({ product, stats }: Props) {
  ...
  return (
    <div className="group rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200 hover:shadow-md focus-within:ring-2 dark:bg-slate-800 dark:ring-slate-700">
      <Link href={`/product/${product.id}`} className="block focus:outline-none">
        ...
        <div className="mt-4 line-clamp-2 text-base font-medium text-slate-700 dark:text-slate-300">
          {product.nameKo}
        </div>
      </Link>
