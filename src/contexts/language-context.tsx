...
const translations = {
  ko: {
    ...
    'nav.ipGoods': 'IP굿즈 상품개발',
    'nav.kit': '기업/웰컴 키트',
    'nav.welcomeKit': '기업/웰컴 키트',
    'nav.group': '단체 판촉',
    'nav.promotional': '단체 판촉',
    'nav.reviews': '리뷰',
    'nav.support': '고객센터',
    'nav.notice': '공지사항',
  ...
  en: {
    ...
    'nav.office': 'Stationery/Office',
    'nav.ipgoods': 'IP Goods Development',
    'nav.ipGoods': 'IP Goods Development',
    'nav.kit': 'Corporate/Welcome Kit',
    'nav.welcomeKit': 'Corporate/Welcome Kit',
    'nav.group': 'Group Promotion',
    'nav.promotional': 'Group Promotion',
    'nav.reviews': 'Reviews',
  ...
  ja: {
    ...
    'nav.ipGoods': 'IP商品開発',
    'nav.kit': '企業/ウェルカムキット',
    'nav.welcomeKit': '企業/ウェルカムキット',
    'nav.group': '団体プロモーション',
    'nav.promotional': '団体プロモーション',
    'nav.reviews': 'レビュー',
  ...
  zh: {
    ...
    'nav.ipGoods': 'IP商品开发',
    'nav.kit': '企业/欢迎套装',
    'nav.welcomeKit': '企业/欢迎套装',
    'nav.group': '团体促销',
    'nav.promotional': '团体促销',
    'nav.reviews': '评论',
    'nav.support': '客户支持',
    'nav.notice': '公告',
